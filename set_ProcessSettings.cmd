...
TASKKILL /F /T /IM NvTelemetryContainer.exe /IM OneDrive.exe /IM acrotray.exe /IM armsvc.exe /IM smartscreen.exe /IM acrobat_sl.exe /IM AdobeUpdateService.exe /IM ctfmon.exe /IM OfficeClickToRun.exe /IM OfficeClickToRun.exe /IM OfficeClickToRun.exe /IM OfficeClickToRun.exe /IM OfficeClickToRun.exe /IM OfficeClickToRun.exe /IM OfficeClickToRun.exe
net stop Spooler
